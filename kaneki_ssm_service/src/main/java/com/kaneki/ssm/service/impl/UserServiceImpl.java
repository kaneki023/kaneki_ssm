...
import com.kaneki.ssm.dao.IUserDao;
...
public class UserServiceImpl implements IUserService {
    ...
    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {  //完成登录以及认证
    ...
    @Override
    public void addRoleToUser(int id, String[] roleIds) throws Exception {
